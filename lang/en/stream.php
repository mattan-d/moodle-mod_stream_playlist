...
$string['collectionmode_help'] = 'When enabled, this activity will automatically collect new video recordings and add them to the playlist. This feature requires the local_stream plugin to be installed and configured.';
