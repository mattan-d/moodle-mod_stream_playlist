...
$string['collectionmode_desc'] = 'הפעל אפשרות זו כדי שהקלטות חדשות ייאספו אוטומטית ויתווספו כרשימת השמעה לפעילות זו (על ידי תוסף חיצוני local_stream).';
$string['collectionmode_help'] = 'כאשר מופעל, פעילות זו תאסוף אוטומטית הקלטות וידאו חדשות ותוסיף אותן לרשימת ההשמעה. תכונה זו דורשת שתוסף local_stream יהיה מותקן ומוגדר.';
