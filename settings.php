...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('stream/builtinaudioplayer',
            get_string('builtinaudioplayer', 'mod_stream'),
            get_string('builtinaudioplayer_desc', 'mod_stream'), ''));
}
